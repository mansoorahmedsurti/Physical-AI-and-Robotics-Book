...
*   **Ubuntu 24.04 LTS**: The recommended operating system is Ubuntu 24.04 LTS (Long Term Support). This Linux distribution provides a stable and widely supported environment for ROS 2 development and compatibility with NVIDIA's ecosystem.
